"""
GPT-4o-mini inference via Azure OpenAI for the DisasterVQA benchmark.

Usage:
    python gpt4o_mini.py \
...
def main():
    parser = argparse.ArgumentParser(description="Azure OpenAI GPT-4o-mini inference for DisasterVQA.")

...
def create_notebook():
    ...
    add_markdown(["## 3. Load Model and Processor"])
    add_code([
        "import torch\n",
    ...
    add_markdown(["## 4. Run Inference (Batching)\nRun generation on the 500 samples."])
    add_code([
    ...
    add_markdown(["## 6. Generate Markdown Table"])
    add_code([
    ...
    with open('disastervqa_filtered_eval.ipynb', 'w') as f:
        json.dump(notebook, f, indent=2)

if __name__ == '__main__':
    create_notebook()
    print("Notebook 'disastervqa_filtered_eval.ipynb' generated successfully.")
